...
final class BankAccountUpdateTest extends WebTestCase
{
    public function testUpdateOk(): void
    {
        ...
        $client->jsonRequest('PATCH', sprintf('bank-accounts/%s', $bankAccount->getUuid()), [
        ...
        self::assertSame('Private Account #2', $body['name']);
    }
